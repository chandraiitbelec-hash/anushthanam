...
const TABS = {
  ...
  pujas: ['slug','title_en','title_te','title_ta','title_hi','deity_slug','occasion_type','duration_minutes','brief_description_en','brief_description_te','brief_description_ta','brief_description_hi','materials_group_slug','prasad_en','prasad_te','prasad_ta','prasad_hi','regional_variation_notes_en','status','translation_status','frequent'],
  occasions: ['slug','title_en','title_te','title_ta','title_hi','description_en','description_te','description_ta','description_hi','icon','display_order','status'],
