/**
 * Uploads detailed content for navagraha-puja:
 ...
 *
 * Usage:
 *   node scripts/upload-puja-detail-navagraha.mjs           (dry run)
 *   node scripts/upload-puja-detail-navagraha.mjs --write   (apply)
 *
 * FLAGS (uncertainties to review before publishing):
 *   [FLAG-NAVAGRAHA-1] A dedicated navagraha-stotram ('Japakusuma sankasham')
 *       is not yet in the shlokas tab. Step 7 links surya-ashtothram as proxy.
 *       Add navagraha-stotram to shlokas and update recite_shloka_slug.
 *   [FLAG-NAVAGRAHA-2] Tamil translations authored from standard liturgical Tamil
...
const content = JSON.parse(
  readFileSync(resolve(__dirname, '../research/navagraha-puja-content.json'), 'utf8')
);
...
console.log('\n══ upload-puja-detail-navagraha.mjs ═════════════════════════════');
...
console.log('\n✅ navagraha-puja upload complete.');
