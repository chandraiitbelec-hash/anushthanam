...
import type { God, Festival, Vratham, Shloka, Story } from '@/lib/types';
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const [gods, festivals, vrathams, shlokas, stories] = await Promise.all([
    getPublished('gods'),
  ...
  return [...staticPages, ...godPages, ...festivalPages, ...vrathamPages, ...shlokaPages, ...storyPages];
}
